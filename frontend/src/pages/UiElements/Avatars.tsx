...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | HomeStore - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for HomeStore - React.js Tailwind CSS Admin Dashboard Template"
      />
