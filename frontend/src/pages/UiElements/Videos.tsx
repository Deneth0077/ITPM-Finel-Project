...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | HomeStore - React.js Admin Dashboard Template"
        description="This is React.js Videos page for HomeStore - React.js Tailwind CSS Admin Dashboard Template"
      />
