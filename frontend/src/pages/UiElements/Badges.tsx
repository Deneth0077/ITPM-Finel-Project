...
export default function Badges() {
  return (
    <div>
      <PageMeta
        title="React.js Badges Dashboard | HomeStore - React.js Admin Dashboard Template"
        description="This is React.js Badges Dashboard page for HomeStore - React.js Tailwind CSS Admin Dashboard Template"
      />
